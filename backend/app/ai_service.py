...
# Default % split of budget across categories — used by the rule-based
# fallback and as a sanity default for the AI-based path too.
BUDGET_SPLIT = {
    "venue": 0.30,
    "catering": 0.25,
    "decoration": 0.10,
...
"""
    ...
    # Rule-based fallback: proportional scaling with protected categories
    ...
    for k, v in old_budget.items():
        if k in protected:
            # Shrink protected categories less aggressively
